...
// Refactor this function - Use the rest operator & an arrow function:
...
[...items.slice(0,Math.floor(Math.random()*items.length)), 
    ...items.slice(Math.floor(Math.random()*items.length)+1)]
